...
public class ContainerThaumAnvil extends Container
{
    ...
    public ContainerThaumAnvil(InventoryPlayer playerInventory, World worldIn, EntityPlayer player)
    {
        this(playerInventory, worldIn, BlockPos.ORIGIN, player);
    }

    public ContainerThaumAnvil(InventoryPlayer playerInventory, final World worldIn, final BlockPos blockPosIn, EntityPlayer player)
    {
        ...
        this.inputSlots = new InventoryBasic("Repair", true, 2)
        {
            ...
            {
                super.markDirty();
                ContainerThaumAnvil.this.onCraftMatrixChanged(this);
            }
        };
        ...
        this.addSlotToContainer(new Slot(this.outputSlot, 2, 134, 47)
        {
            ...
            {
                return (playerIn.capabilities.isCreativeMode || playerIn.experienceLevel >= ContainerThaumAnvil.this.maximumCost) && ContainerThaumAnvil.this.maximumCost > 0 && this.getHasStack();
            }
            public ItemStack onTake(EntityPlayer thePlayer, ItemStack stack)
            {
                if (!thePlayer.capabilities.isCreativeMode)
                {
                    thePlayer.addExperienceLevel(-ContainerThaumAnvil.this.maximumCost);
                }

                float breakChance = net.minecraftforge.common.ForgeHooks.onAnvilRepair(thePlayer, stack, ContainerThaumAnvil.this.inputSlots.getStackInSlot(0), ContainerThaumAnvil.this.inputSlots.getStackInSlot(1));

                ContainerThaumAnvil.this.inputSlots.setInventorySlotContents(0, ItemStack.EMPTY);

                if (ContainerThaumAnvil.this.materialCost > 0)
                {
                    ItemStack itemstack = ContainerThaumAnvil.this.inputSlots.getStackInSlot(1);

                    if (!itemstack.isEmpty() && itemstack.getCount() > ContainerThaumAnvil.this.materialCost)
                    {
                        itemstack.shrink(ContainerThaumAnvil.this.materialCost);
                        ContainerThaumAnvil.this.inputSlots.setInventorySlotContents(1, itemstack);
                    }
                    else
                    {
                        ContainerThaumAnvil.this.inputSlots.setInventorySlotContents(1, ItemStack.EMPTY);
                    }
                }
                else
                {
                ...
                ContainerThaumAnvil.this.maximumCost = 0;
    ...
    public void updateRepairOutput()
    {
        ...
        else
        {
            ...
            {
                if (!ContainerThaumAnvil.onAnvilChange(this, itemstack, itemstack2, outputSlot, repairedItemName, j)) return;
    ...
    public static boolean onAnvilChange(ContainerThaumAnvil container, @Nonnull ItemStack left, @Nonnull ItemStack right, IInventory outputSlot, String name, int baseCost)
    {
