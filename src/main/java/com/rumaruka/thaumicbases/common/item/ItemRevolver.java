...
public class ItemRevolver extends Item implements IWarpingGear {
    public ItemRevolver() {
        ...
        addPropertyOverride(new ResourceLocation(TBCore.modid, "eldritch"), (stack, worldIn, entityIn) -> ItemRevolver.getUpgradeLevel(stack, RevolverUpgrade.eldritch) > 0 ? 1F : 0F);
    }
