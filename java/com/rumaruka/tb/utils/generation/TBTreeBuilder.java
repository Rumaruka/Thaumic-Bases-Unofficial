package com.rumaruka.tb.utils.generation;

import com.rumaruka.tb.common.block.BlockTBLeaves;
import com.rumaruka.tb.common.block.BlockTBLog;
import com.rumaruka.tb.common.block.BlockTBSapling;
...
public class TBTreeBuilder extends WorldGenAbstractTree {
    ...
    private BlockTBSapling sapling;
    private BlockTBLeaves blockLeaves;
    private BlockTBLog blockLog;
    private static Random rand = new Random();

    public TBTreeBuilder(boolean par1, Block sapling, Block blockLeaves, Block blockLog) {
        this(par1, 4 + rand.nextInt(2), 3, 3, false, (BlockTBSapling) sapling, (BlockTBLeaves) blockLeaves, (BlockTBLog) blockLog);


    }
    public TBTreeBuilder(boolean par1, int height, int wood, int leaves, boolean vines, BlockTBSapling sapling, BlockTBLeaves blockLeaves, BlockTBLog blockLog) {
        super(par1);
