...
public class KnowledgeTB {
    ...
    private static void $init()
    {
        ...
        new REB().setBaseInfo("TB.TREE", "tbtree", 10, 2, new ItemStack(TBBlocks.goldensapling)).setStages(new RSB().setText("research_stage." + TBCore.modid + ":tbtree.1").setConsumedItems(new ItemStack(Blocks.SAPLING,1,0)).setRecipes("TB.goldenSapling").build()).setParents("TB.CACTUS").buildAndRegister();
        new REB().setBaseInfo("TB.TREE1", "tbtree1", 10, 0, new ItemStack(TBBlocks.endersapling)).setStages(new RSB().setText("research_stage." + TBCore.modid + ":tbtree1.1").setConsumedItems(new ItemStack(Blocks.SAPLING,1,0)).setRecipes("TB.enderSapling").build()).setParents("TB.TREE").buildAndRegister();
        new REB().setBaseInfo("TB.TREE2", "tbtree2", 10, 4, new ItemStack(TBBlocks.nethersapling)).setStages(new RSB().setText("research_stage." + TBCore.modid + ":tbtree2.1").setConsumedItems(new ItemStack(Blocks.SAPLING,1,0)).setRecipes("TB.netherSapling").setWarp(3).build()).setParents("TB.TREE").buildAndRegister();
