...
public class GuiVoidAnvil extends GuiContainer implements IContainerListener
{
    private static final ResourceLocation ANVIL_RESOURCE = new ResourceLocation("textures/gui/container/anvil.png");
    private final ContainerVoidAnvil anvil;
    private GuiTextField nameField;
    private final InventoryPlayer playerInventory;

    public GuiVoidAnvil(InventoryPlayer inventoryIn, World worldIn, int x, int y, int z)
    {
        super(new ContainerVoidAnvil(inventoryIn, worldIn, new BlockPos(x, y, z), Minecraft.getMinecraft().player));
        this.playerInventory = inventoryIn;
        this.anvil = (ContainerVoidAnvil) this.inventorySlots;
    }
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
    {
        ...
        if (this.anvil.maximumCost > 0)
        {
            ...
            if (this.anvil.maximumCost >= 60 && !this.mc.player.capabilities.isCreativeMode)
            {
