...
public class WorldGenBigOak extends WorldGenAbstractTree
{
    ...
    boolean validTreeLocation()
    {
        ...
        boolean isSoil = block.canSustainPlant(worldObj.getBlockState(new BlockPos(basePos[0], basePos[1] - 1, basePos[2])), worldObj, new BlockPos(basePos[0], basePos[1] - 1, basePos[2]), EnumFacing.UP, (IPlantable) Blocks.SAPLING);
        if (!isSoil)
        {
            return false;
        }
