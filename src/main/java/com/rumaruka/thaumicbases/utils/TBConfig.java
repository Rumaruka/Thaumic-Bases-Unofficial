...
public class TBConfig implements IDummyConfig {
    ...
    public void load(Configuration config) {
        ...
        /**
         * AeXiaohu modified
         * 增加超吟附魔台附魔等级配置-初始化overchanterEnchantmentLevel
         */
        overchanterEnchantmentLevel = cfg.getInt("overchanterEnchantmentLevel", "Enchantments", 1, 0, Integer.MAX_VALUE, "The level of enchantment that Overchanter has increased"); // End of modification
    ...
    /**
     * AeXiaohu modified
     * 增加超吟附魔台附魔等级配置-定义overchanterEnchantmentLevel
     */
    public static int overchanterEnchantmentLevel; // End of modification
    ...
    /**
     * AeXiaohu modified
     * 增加超吟附魔台附魔等级配置-定义overchanterEnchantmentLevel的getter
     */
    public static int getOverchanterEnchantmentLevel() {
        return overchanterEnchantmentLevel;
    } // End of modification
}
