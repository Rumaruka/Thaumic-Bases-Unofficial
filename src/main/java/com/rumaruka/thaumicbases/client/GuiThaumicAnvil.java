...
public class GuiThaumicAnvil extends GuiContainer implements IContainerListener
{
    private static final ResourceLocation ANVIL_RESOURCE = new ResourceLocation("textures/gui/container/anvil.png");
    private final ContainerThaumicAnvil anvil;
    private GuiTextField nameField;
    private final InventoryPlayer playerInventory;

    public GuiThaumicAnvil(InventoryPlayer inventoryIn, World worldIn, int x, int y, int z)
    {
        super(new ContainerThaumicAnvil(inventoryIn, worldIn, new BlockPos(x, y, z), Minecraft.getMinecraft().player));
